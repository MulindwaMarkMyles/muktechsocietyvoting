"""
Django settings for mts_voting project.
...
SECRET_KEY = 'django-insecure-mxicltb#cfv@dyoz95wr+1c(dy#tu#8syg1ai#+v75-w9401lx'
...
WSGI_APPLICATION = 'mts_voting.wsgi.application'
